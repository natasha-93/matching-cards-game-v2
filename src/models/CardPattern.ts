...
export const patterns: CardPattern[] = [
  {
    ...
    gradient: `linear-gradient(
      111deg,
      rgba(62, 165, 238, 0.6) 13%,
      rgba(3, 215, 249, 0.6) 91%
    )`,
    url:
